...
//        layout.addView(button1)
       ...
       val YouTubePlayerView=YouTubePlayerView(this)
        YouTubePlayerView.layoutParams=ConstraintLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT)
        YouTubePlayerView.addView(YouTubePlayerView)
